...
``` {r echo=FALSE, Univariate_Residual_Sugar}
...
```{r echo=FALSE, Bivariate_Alcohol}
...
```{r echo=FALSE, Bivariate_Chlorides}
...
```{r echo=FALSE, Bivariate_Strongest}
...
```{r echo=FALSE, Bivariate_Sulphates}
...
```{r echo=FALSE, Bivariate_Fixed_Acidity}
...
ggplot(aes(x = density, y = alcohol), data=df) + geom_point()
...
```{r echo=FALSE, Multivariate_Relationships}
...
```{r echo=FALSE, Multivariate_Surprise}
